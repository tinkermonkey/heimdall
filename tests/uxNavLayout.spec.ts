...
import { uxNavLayout, type UxNavLayoutOptions } from '../src/utils/uxNavLayout'
...
test.describe('uxNavLayout', () => {
  ...
  test('positions single view node relative to page parent', () => {
    ...
    const edges: HierarchyEdge[] = [{ source: 'page1', target: 'view1', structural: true }]
  ...
  test('positions multiple views as horizontal fan', () => {
    const nodes = [createNode('page1'), createNode('view1'), createNode('view2'), createNode('view3')]
    const edges: HierarchyEdge[] = [
  ...
  test('respects custom viewSpacing option', () => {
    const nodes = [createNode('page1'), createNode('view1'), createNode('view2')]
    const edges: HierarchyEdge[] = [
      { source: 'page1', target: 'view1', structural: true },
      { source: 'page1', target: 'view2', structural: true },
    ]
  ...
  test('handles mixed tree structures with multiple levels and views', () => {
    ...
    const dims = createDims(['page1', 'page1_child', 'view1', 'view2', 'page2'])
  ...
  test('handles deeply nested page hierarchies', () => {
    ...
    const edges: HierarchyEdge[] = [
      { source: 'page1', target: 'page1_child', structural: true },
      { source: 'page1_child', target: 'page1_child_grandchild', structural: true },
      { source: 'page1_child_grandchild', target: 'page1_child_grandchild_great', structural: true },
    ]
    const dims = createDims(nodes.map(n => n.id))
