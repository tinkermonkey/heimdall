 ...
 * - Amber accent tokens are in place
...
test.describe('integration: Foundation Tests', () => {
  ...
  test('should have amber accent as primary color', async ({ page }) => {
    await assertAmberAccent(page)
  })
})
