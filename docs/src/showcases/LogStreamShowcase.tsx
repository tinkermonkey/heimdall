...
import {
  ...
  PropsTable,
  PropRow,
} from "../components/ShowcaseSection";

export function LogStreamShowcase() {
  const [staticEntries] = useState<LogEntry[]>([
    {
      id: "log-1",
      timestamp: "2026-06-05T14:30:15Z",
      level: "INFO",
      message: "Server started on port 3000",
    },
    {
      id: "log-2",
      timestamp: "2026-06-05T14:30:16Z",
      level: "INFO",
    ...
    {
      id: "log-4",
      timestamp: "2026-06-05T14:30:20Z",
      level: "WARN",
      message: "Deprecated middleware detected in route /api/v1",
    },
    {
      id: "log-5",
      timestamp: "2026-06-05T14:30:22Z",
      level: "INFO",
      message: "Cache warmed up (15,432 entries)",
    },
    {
      id: "log-6",
      timestamp: "2026-06-05T14:30:25Z",
      level: "DEBUG",
      message: "Health check endpoint responding normally",
    },
    {
      id: "log-7",
      timestamp: "2026-06-05T14:30:27Z",
      level: "INFO",
      message: "Message queue listener initialized",
    },
    {
      id: "log-8",
      timestamp: "2026-06-05T14:30:30Z",
      level: "ERROR",
      message: "Failed to connect to backup database, retrying...",
    },
    {
      id: "log-9",
      timestamp: "2026-06-05T14:30:32Z",
      level: "INFO",
      message: "Backup database connection recovered",
    },
    {
      id: "log-10",
      timestamp: "2026-06-05T14:30:35Z",
      level: "WARN",
      message: "Memory usage approaching threshold: 87.3%",
    },
    {
      id: "log-11",
      timestamp: "2026-06-05T14:30:38Z",
      level: "INFO",
      message: "Scheduled maintenance task started",
    },
    {
      id: "log-12",
      timestamp: "2026-06-05T14:30:42Z",
      level: "INFO",
  ...
  const opsEntries: LogEntry[] = [
    ...
    {
      id: "op-3",
      timestamp: "2026-06-05T14:30:17Z",
      level: "WARN",
      op: "cache_miss",
    ...
    {
      id: "op-5",
      timestamp: "2026-06-05T14:30:19Z",
      level: "INFO",
      op: "retry",
      target: "db_query:1",
      message: "Retrying operation (attempt 1/3)",
    },
    {
      id: "op-6",
      timestamp: "2026-06-05T14:30:21Z",
      level: "INFO",
      op: "queue_message",
      target: "queue:emails",
      message: "Pushed 3 messages to queue",
    },
  ];
  ...
  return (
    <div>
      ...
      <ShowcaseSection label="Features">
        ...
        >
          <li>
            <strong>Real-time streaming:</strong> Designed for live log tail
            with efficient updates
          </li>
          <li>
            <strong>Auto-follow:</strong> Automatically scrolls to newest entry;
            pauses when user scrolls up
          </li>
          <li>
            <strong>Color-coded levels:</strong> INFO (blue), WARN (amber),
            ERROR (rose), DEBUG (violet)
          </li>
          <li>
            <strong>Timestamp formatting:</strong> Compact time display
            (HH:mm:ss)
          </li>
          <li>
            <strong>Operation tracking:</strong> Optional op and target columns
            for operation-level logging
          </li>
          <li>
            <strong>Virtual scrolling:</strong> Efficient rendering of large log
            buffers
          </li>
          <li>
            <strong>Max rows limiting:</strong> Configurable buffer size
            (default 500 rows)
          </li>
          <li>
          ...
          <li>
            <strong>Unique keying:</strong> Automatic deduplication using id,
            timestamp, level, message, op, target
          </li>
          <li>
            <strong>Accessibility:</strong> Live region announcements when
            following
          </li>
        </ul>
      </ShowcaseSection>
      ...
      <ShowcaseSection label="Props">
        <PropsTable>
          ...
          <PropRow
            ...
            type="boolean"
            def="true"
            description="When true, auto-scrolls to newest entry and announces changes"
          />
          <PropRow
            name="maxRows"
            type="number"
          ...
          <PropRow
            ...
            type="boolean"
            def="false"
            description="When true, displays op and target columns"
          />
          <PropRow
            name="aria-label"
            type="string"
            def="Log stream"
            description="Accessibility label for the log container"
          />
        </PropsTable>
      </ShowcaseSection>
      ...
      <ShowcaseSection label="LogEntry Type">
        <PropsTable>
          <PropRow
            name="id"
            type="string"
            description="Optional unique entry identifier"
          />
          <PropRow
            name="timestamp"
            type="Date | string"
            description="Log entry timestamp (ISO string or Date object)"
            required
          />
          <PropRow
            name="level"
          ...
          <PropRow
            name="op"
            type="string"
            description="Optional operation name (shown when showOps is true)"
          />
          <PropRow
            name="target"
            type="string"
            description="Optional target identifier (shown when showOps is true)"
          />
        </PropsTable>
      </ShowcaseSection>
