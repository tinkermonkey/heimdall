...
const ICONS = {
  ...
  // --- Lucide-aligned aliases (parity with @tinkermonkey/heimdall-ui Icon.tsx) ---
  // The code library uses these names; design prototypes can use either and both
  // resolve to the same glyph. Added 2026-05-30 from the design↔code parity loop.
  ...
  externalLink:   '<path d="M7 17 17 7"/><path d="M7 7h10v10"/>',
  hardDrive:      '<path d="M22 12H2"/><path d="M5.5 6h13l3 6v6a1 1 0 0 1-1 1H3.5a1 1 0 0 1-1-1v-6z"/><path d="M6 16h.01M10 16h.01"/>',
};
